...
The theme of this project is "Movie Recommendation System Algorithm Creation".
The given dataset is the "Movie Lens 10M version," which is the background that the edX management has taken into account to lighten the computational load for us.
...
<u>**Supplemental information on RMSE**</u>

Before I explain RMSE, let me explain MSE (Mean Squared Error).
MSE is the mean of the squared difference between the predicted and measured values. Squaring absorbs the pluses and minuses of deviations and at the same time reflects the greater impact of large errors and the smaller impact of small errors.
...
As an alternative, the RMSE, which is the square root of the MSE, is used.
It is one of the most popular accuracy indices for forecasting. It is frequently used in Japanese business practice.
